...
class DepartmentReportController extends Controller
{
    ...
    /**
     * Department-wise summary reports (patients, consultations, admissions, ALOS, revenue).
     */
    public function index(Request $request): JsonResponse
    {
        ...
        $data = $this->reportService->getDepartmentReport($branchId, $preset, $customStart, $customEnd);

        return ApiResponse::success($data, 'Department-wise report retrieved.');
    }
}
